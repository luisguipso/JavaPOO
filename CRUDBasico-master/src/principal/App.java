...
public class App {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        declaracao.execute("CREATE TABLE if not exists PESSOA(ID INT NOT NULL IDENTITY, NOME VARCHAR(255) NOT NULL UNIQUE, RG VARCHAR(255) NOT NULL , CPF VARCHAR(255) NOT NULL, IDCIDADE INTEGER NOT NULL);");        //declaracao.execute("ALTER TABLE CIDADE ADD FOREIGN KEY (IDESTADO) REFERENCES ESTADO(ID)");
